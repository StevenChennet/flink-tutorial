...
// */
//@PublicEvolving
//public class TeldJsonRowDeserializationSchema implements DeserializationSchema<Row> {
//
...
//
//    private TeldJsonRowDeserializationSchema(
...
//     */
//    @Deprecated
//    public TeldJsonRowDeserializationSchema(TypeInformation<Row> typeInfo) {
//        this(typeInfo, false);
//    }
//
//    /**
...
//     */
//    @Deprecated
//    public TeldJsonRowDeserializationSchema(String jsonSchema) {
...
//
//    /**
//     * Builder for {@link TeldJsonRowDeserializationSchema}.
//     */
...
//        }
//
//        public TeldJsonRowDeserializationSchema build() {
//            return new TeldJsonRowDeserializationSchema(typeInfo, failOnMissingField);
//        }
//    }
//
//    @Override
...
//            return false;
//        }
//        final TeldJsonRowDeserializationSchema that = (TeldJsonRowDeserializationSchema) o;
...
//        LocalDate localDate;
//
//        //如果要解析字段符合时间戳规则,则按照时间戳方式解析
//        if (13 == jsonNode.asText().trim().length() || 10 == jsonNode.asText().trim().length()) {
//            long timeJson = jsonNode.asLong();
//            Instant instant = Instant.ofEpochMilli(timeJson);
//            LocalDateTime localDateTime = LocalDateTime.ofInstant(instant, ZoneId.systemDefault());
//            localTime = localDateTime.query(TemporalQueries.localTime());
//            localDate = localDateTime.query(TemporalQueries.localDate());
//
//        } else {
//            TemporalAccessor localDateTime = RFC3339_TIMESTAMP_FORMAT.parse(jsonNode.asText());
